...
export class RenderPage {
                    ...
                    <div class="news page">
                        <div class="overlay">
                            <div class="content">
                                ...
                                <img src="/${novelty.image.large}" style="max-width: 950px; padding-left: 150px" />
    ...
    renderSearchNews(news) {
        const page = document.querySelector(CONFIG.selectors.newsList);
        page.innerHTML = '';
        news.forEach(item => {
            const div = document.createElement('div');
            page.append(div);
            div.innerHTML = `
            <li class="page" style="padding-bottom: 30px" data-index="${item.id}">
                <div class="news-string">
                    <a href="#" class="news-photo"><img src="/${item.image.small}" height="130" alt="${item.title}"/></a>
                    <h2 class="titleEl" style="padding-left: 10px"><a href="#"> ${item.title} </a></h2>
                </div>
            </li>`
        })
                ...
                <div class="about-page row">
                    <div class="kursant-table col-6">
                        <div class="kursant-image"><img src="data:image/jpeg;base64," style="width:100px"></div>
                            <div class="h4 iinfo__name">Вадим Коронец</div>
                            <p ">Курсант курса: <a href="<a href="https://www.grodno.it-academy.by/course/front-end-developer/razrabotka-veb-prilozhenii-na-javascript/">Разработка веб-приложений на JavaScript</a></p>
                        </div>
                   

                    <div class="page-footer-column col-6">
